...
def check_shape_lr(data,
    ...
    if features is not None:
        assert features.shape == shape_data_lr
    else:
    ...
    if targets is not None:
        assert targets.shape == shape_ranks_lr
    else:
...
def check_shape_plr(data,
    ...
    # the number of features for the data
    if features is not None:
        assert features.shape == shape_data_plr
    else:
        assert features is None
    ...
    # number of classes for the rankings
    if targets is not None:
        assert targets.shape == shape_ranks_plr
    else:
        assert targets is None
...
def test_load_authorship():
    ...
    authorship = load_authorship(problem="label_ranking")
    ...
    authorship = load_authorship(problem="partial_label_ranking")
...
def test_load_glass():
    ...
    glass = load_glass("label_ranking")
    ...
    glass = load_glass("partial_label_ranking")
    # Partial Label Ranking
    check_shape_plr(
        data=glass,
...
def test_load_iris():
    ...
    iris = load_iris("partial_label_ranking")
    # Partial Label Ranking
    check_shape_plr(
        data=iris,
...
def test_load_pendigits():
    ...
    pendigits = load_pendigits("label_ranking")
    ...
    pendigits = load_pendigits("partial_label_ranking")
    # Partial Label Ranking
    check_shape_plr(
        data=pendigits,
...
def test_load_segment():
    ...
    segment = load_segment("label_ranking")
    ...
    segment = load_segment("partial_label_ranking")
    # Partial Label Ranking
    check_shape_plr(
        data=segment,
...
def test_load_vehicle():
    ...
    vehicle = load_vehicle("label_ranking")
    ...
    vehicle = load_vehicle("partial_label_ranking")
    # Partial Label Ranking
    check_shape_plr(
        data=vehicle,
...
def test_load_vowel():
    ...
    vowel = load_vowel("label_ranking")
    ...
    vowel = load_vowel("partial_label_ranking")
    # Partial Label Ranking
    check_shape_plr(
        data=vowel,
...
def test_load_wine():
    ...
    wine = load_wine("partial_label_ranking")
    # Partial Label Ranking
    check_shape_plr(
        data=wine,
